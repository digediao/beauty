    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['beauty:brand:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['beauty:brand:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listBrand, getBrand, delBrand, addBrand, updateBrand } from "@/api/beauty/brand";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('beauty/brand/export', {
        ...this.queryParams
